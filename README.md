...
- In general, certain features (e.g., those requiring authorization by protected secrets) are simply impossible implement without a programmable backend, hence the above limitations.
